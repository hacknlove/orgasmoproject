...
const getPageConfig_export_1 = require("./pages/getPageConfig.export");
const getPageConfigFromId_export_1 = require("./pages/getPageConfigFromId.export");
...
const driver = {
    ...
    ["pages.getPageConfig"]: getPageConfig_export_1.default,
    ["pages.getPageConfigFromId"]: getPageConfigFromId_export_1.default,
...
driver["pages"] = {};
driver["pages"]["getPageConfig"] = getPageConfig_export_1.default;
driver["pages"]["getPageConfigFromId"] = getPageConfigFromId_export_1.default;
driver["site"] = {};
