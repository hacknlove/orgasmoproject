    ...
    page: {
        delete({ item, fileDescriptor: { pageId } }) {
            for (const [path, pageIds] of Object.entries(item.props.pages)) {
                for (const testPageId of Object.keys(pageIds)) {
...
function updateNavDelete({ dynamicState, fileDescriptor }) {
...
exports.default = updateNavDelete;
//# sourceMappingURL=updateNavDelete.js.map