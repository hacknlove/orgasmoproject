...
function GlobalSettingsItem() {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { onClick: () => setActiveFilepath(filePath), children: (0, jsx_runtime_1.jsxs)("a", { id: "MainLayout_nav_home_o", className: selected ? "MainLayout_nav_active_o" : "", children: [(0, jsx_runtime_1.jsx)(MaterialSymbolsSettingsRounded_1.default, { className: "MainLayout_nav_svg" }), " ", (0, jsx_runtime_1.jsx)("span", { children: "Global settings" })] }) }));
}
exports.default = GlobalSettingsItem;
//# sourceMappingURL=GlobalSettingsItem.dynamic.js.map