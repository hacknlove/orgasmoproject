...
function KVStorageLi({ label, description }) {
    ...
    return ((0, jsx_runtime_1.jsx)("li", { className: `MainLayout_nav_li_ul_li ${selected ? "MainLayout_nav_active_o" : ""}`, onClick: () => setActiveFilepath(filePath), children: (0, jsx_runtime_1.jsxs)("a", { className: "MainLayout_nav_li_ul_li_a", title: description, children: [(0, jsx_runtime_1.jsx)(GrommetIconsStorage_1.default, { className: "MainLayout_nav_svg" }), " ", label, " ", isDirty ? "*" : ""] }) }));
}
exports.default = KVStorageLi;
//# sourceMappingURL=KVStorageLi.js.map