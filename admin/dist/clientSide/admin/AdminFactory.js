...
function AdminFactory({ DComponent, Components, Page }) {
    const AdminPage = ({ pageConfigs, resolvedUrl, adminPageConfig, driverMethods, }) => {
        ...
        return (0, react_1.useMemo)(() => {
            if (adminPageConfig.layout?.name) {
                return ((0, jsx_runtime_1.jsx)(DComponent, { type: adminPageConfig.layout?.name, admin: adminRendered, page: pageRendered }));
            }
