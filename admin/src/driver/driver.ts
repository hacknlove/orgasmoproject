...
const driver = {
  ["_oadmin.playGround.deleteFile.POST"]: _oadminーplayーroundーdeleteーileーPOST,
...
driver["_oadmin"]["playGround"]["deleteFile"]["POST"] = _oadminーplayーroundーdeleteーileーPOST;
driver["_oadmin"]["playGround"]["expand"] = {};
driver["_oadmin"]["playGround"]["expand"]["POST"] = _oadminーplayーroundーexpandーPOST;
...
driver["_oadmin"]["playGround"]["saveFile"]["POST"] = _oadminーplayーroundーsaveーileーPOST;
driver["playground"] = {};
